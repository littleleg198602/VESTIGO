...
RC_DEFINITIONS: dict[int, RCDefinition] = {
    ...
    106: _rc(106, "Shoda barvy vodiče a signálu", "Wire and signal color consistency", "Kontrola porovnává skutečnou a požadovanou barvu vodiče pro daný signál.", "This check compares actual and required wire color for the given signal.", ["Signalname", "Signal"], ["IST-Farbe", "SOLL-Farbe", "Farben-Übereinstimmung"], "Ověřit a opravit shodu barvy vodiče s potenciálovou listinou.", "Verify and correct the wire color against the potential list.", object_type_cz="Drát", object_type_en="Wire", handler="rc106"),
