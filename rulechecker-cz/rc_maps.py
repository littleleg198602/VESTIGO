...
RC_DEFINITIONS: dict[int, RCDefinition] = {
    ...
    112: _rc(112, "Kontrola svazku", "Bundle consistency check", "Kontroluje, zda všechny vodiče na spoji mají stejný potenciál a stejnou barvu vodičů.", "This check verifies wire bundle consistency.", ["Leitungsnummer"], ["Meldung", "Leitungsnummer"], "Opravit záznam svazku podle pravidla RC.", "Correct the bundle record according to the RC rule.", object_type_cz="Splice", object_type_en="Splice"),
    ...
    191: _rc(191, "Kontrola atributů vedení", "Wire attribute check", "Kontrola polarity ethernetových kabelů a napětí\nKontroluje, zda jsou všechna ethernetová připojení správně polarizována a zda jsou použity správné kabely a barvy vodičů.", "This check verifies required wire attributes.", ["Leitungsnummer"], ["Meldung", "Leitungsnummer"], "Doplnit nebo opravit atributy vedení.", "Complete or correct wire attributes.", object_type_cz="Drát", object_type_en="Wire"),
    314: _rc(314, "Kontrola signálu", "Signal consistency check", "Kontrola spojení mezi všemi účastníky a zemnícím vodičem\nKontroluje, zda jsou všichni účastníci na sběrnici LIN připojeni ke stejnému zemnícímu vodiči.", "This check verifies signal mapping to wire.", ["Signalname"], ["Signal", "Meldung"], "Opravit mapování signálu na vedení.", "Correct signal-to-wire mapping.", object_type_cz="Signál", object_type_en="Signal"),
    ...
    907: _rc(907, "Kontrola větve svazku", "Harness branch check", "Kontroluje, zda rozložení zátěže splňuje specifikace referenčního seznamu / VW75212.", "This check verifies harness branch consistency.", ["Leitungspfad"], ["Leitungspfad", "Meldung"], "Opravit definici větve svazku.", "Correct the harness branch definition.", object_type_cz="Svazek", object_type_en="Harness"),
    1005: _rc(1005, "Kontrola pojistky", "Fuse consistency check", "Kontroluje, zda jsou pojistky a typy pojistek správně pojmenovány.", "This check verifies fuse data consistency.", ["Sicherungsname", "Sicherungstyp"], ["Sicherungsname", "Sicherungstyp", "Meldung"], "Opravit nastavení pojistky dle pravidla.", "Correct fuse setup according to rule.", object_type_cz="Pojistka", object_type_en="Fuse"),
    1007: _rc(1007, "Kontrola použití konektoru", "Connector usage point check", "Kontroluje, zda je pro konektor zadáno místo použití (s porovnáním seznamu rodičů).", "This check verifies that a connector usage point (Verwendungsstelle) is provided and matches the master-list data.", ["Bauteil", "VOBES-ID", "Verwendungsstelle"], ["Verwendungsstelle", "Meldung"], "Doplnit nebo opravit použitou pozici konektoru dle mateřského seznamu.", "Add or correct the connector usage point according to the master list.", object_type_cz="Konektor", object_type_en="Connector"),
    ...
    3002: _rc(3002, "Kontrola geometrie propojení", "Connection geometry check", "Porovnává součet délek kabelů se vzdáleností mezi dvěma koncovými body a kontroluje, zda je rozdíl neobvykle velký.", "This check compares wire length and endpoint distance.", ["Startpunkt", "Endpunkt", "Potential"], ["Startpunkt", "Endpunkt", "Potential", "Σ Leitungslänge [mm]", "Abstand Endpunkte [mm]", "Ergebnis Hinweis", "Leitungspfad"], "Prověřit geometrii vedení a upravit trasu.", "Review connection geometry and adjust routing.", object_type_cz="Spoj", object_type_en="Connection"),
}
